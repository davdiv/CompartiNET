...
export const commandForAddRoute = ({ netns, route }: AddRouteAction) => [...getNetnsPrefix(netns), "ip", "route", "add", ...getRouteParam(route)];

export const commandForRemoveRoute = ({ netns, route }: RemoveRouteAction) => [...getNetnsPrefix(netns), "ip", "route", "del", ...getRouteParam(route)];
